classdef TimeVaryingDynSystem < SimObject
    properties
        initialStates
        stateNames
        inputNames
    ...
    methods
        function obj = TimeVaryingDynSystem(initialStates, stateNames, inputNames, derivFun, outputFun, name)
            arguments
                initialStates
                stateNames
                inputNames
